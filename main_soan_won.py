...
def _init_():
    ...
    os.system('cp models/SoAN_won.py outputs' + '/' + args.exp_name + '/' + 'SoAN_won.py.backup')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_dir", type=str, default="outputs/SoAN_won/models/model_optimal.pt")
    parser.add_argument("--train_yaml", type=str, default="conf/train_soan_won.yaml")
    parser.add_argument("--batch_size", type=int, default=32)
    parser.add_argument("--exp_name", type=str, default="SoAN_won")
