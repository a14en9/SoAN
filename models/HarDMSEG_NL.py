...
class HarDMSEG_NL(nn.Module):
    ...
    def __init__(self, inchannels = 15, outchannels=3, channel=32):
        ...
        """
        self.hardnet = hardnet_nl(arch=68, inchannels = inchannels, pretrained=False)
