...
def _init_():
    ...
    os.system('cp models/HarDMSEG_NL.py outputs' + '/' + args.exp_name + '/' + 'HarDMSEG_NL.py.backup')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--saved_model_dir", type=str, default="outputs/HarDMSEG_NL/models/model_optimal.pt")
    parser.add_argument("--train_yaml", type=str, default="conf/train_hardmseg_nl.yaml")
    parser.add_argument("--batch_size", type=int, default=32)
    parser.add_argument("--exp_name", type=str, default="HarDMSEG_NL")
