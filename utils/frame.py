...
from models.HarDMSEG import *
from models.HarDMSEG_NL import *
from models.SoAN_won import *
from models.SoAN_wn import *
# from .metrics import bce_diceloss, diceloss
...
class Framework:
    ...
    def __init__(self, loss_fn=None, model_opts=None, optimizer_opts=None,
                 reg_opts=None, epochs=None, device=None):
        """
        ...
        if model_opts.name in ["Unet", "UnetDropout", "HarDMSEG", "HarDMSEG_NL","SoAN_won", "SoAN_wn"]:
        ...
        self.lrscheduler = ReduceLROnPlateau(self.optimizer, "min",
                                             ...
                                             min_lr=1e-6)
        # self.lrscheduler = CosineAnnealingLR(self.optimizer, epochs, eta_min=1e-3)
    ...
    def save(self, out_dir, epoch):
        ...
        optim_path = Path(out_dir, f"optimizer_{epoch}.pt")
