...
from preprocessing.process_slices_funs import postprocess_tile
...
def inference(img, model, process_conf, overlap=0, infer_size=256, device=None):
    ...
    predictions = np.zeros((I, J, 1, slice_size[0], slice_size[1], 2))
